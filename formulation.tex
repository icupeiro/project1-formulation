...
An overview of the most common modifying and bounding parameters in building control together with their associated varialbes  is given in Table~\ref{tab:mpc_form:parameters:modifiers} and Table~\ref{tab:mpc_form:parameters:bounds}, respectively.
...
\begin{table}[h]
	...
	\begin{tabular}{l|c|l|c}
		...
		Efficiency & $\eta^i$ & \makecell[l]{Efficiency of other  $i$-th system} & $T_{sup}, Q^i_{\text{HVAC}}, P^i_{\text{HVAC}}$ \\
		\midrule
		...
		RES factor & $r^i$ & \makecell[l]{Ratio of renewable energy of \\ the considered component $i$} & $Q^i_{\text{HVAC}}$ \\
			\midrule
		\textbf{Heat flow parameters}  & \textbf{Symbol} &  \textbf{Description} \\
		\midrule
		Specific heat capacity & $c_p^i$ & \makecell[l]{Specific heat capacity of \\ $i$-th medium} & $T_{sup}, T_{ret}, m_{\text{wat}}, m_{\text{air}}, Q^i_{\text{HVAC}}$ \\
		\midrule
