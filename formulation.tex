...
\begin{subequations}
	...
	& s_{k} = h(x_k, y_k, u_k, d_k),  & k \in \mathbb{N}_{0}^{N-1} & \label{eq:mpc_general_formal:yp} \\
...
Sets  $\mathcal{X}$, $\mathcal{U}$ and $\mathcal{S}$ represent feasible subset of $\mathbb{R}^{n}$. 
